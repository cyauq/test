...
{
	public string DeviceName = "Surasole-37-38R";
	...
	void Update ()
	{
		if (_timeout > 0f)
		{
			...
			if (_timeout <= 0f)
			{
				...
				case States.Scan:
					BluetoothStatus.text = "Scanning for Surasole-37-38R devices...";
					...
					BluetoothLEHardwareInterface.ScanForPeripheralsWithServices (null, (address, name) => {
						...
						if (name.Contains (DeviceName))
						{
							...
							HM10_Status.text = "Found Surasole-37-38R";
				...
				case States.Connect:
					...
					HM10_Status.text = "Connecting to Surasole-37-38R";
					...
					BluetoothLEHardwareInterface.ConnectToPeripheral (_hm10, null, null, (address, serviceUUID, characteristicUUID) => {
						...
						if (IsEqual (serviceUUID, ServiceUUID))
						{
							...
							if (IsEqual (characteristicUUID, Characteristic))
							{
								...
								HM10_Status.text = "Connected to Surasole-37-38R";
							}
						}
					}, (disconnectedAddress) => {
