            ...
            for (int i = 0; i < pathController.tilesQuantity.Count; i++)
            {
                switch (i)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        pathGameObjectModel.GeneratedPath6 = Instantiate(pathList[i], pathPositionModel.Path6PosValue, Quaternion.identity) as GameObject;
                        break;
                    case 6:
                        pathGameObjectModel.GeneratedPath7 = Instantiate(pathList[i], pathPositionModel.Path7PosValue, Quaternion.identity) as GameObject;
                        break;
                    case 7:
                        pathGameObjectModel.GeneratedPath8 = Instantiate(pathList[i], pathPositionModel.Path8PosValue, Quaternion.identity) as GameObject;
                        break;
                }
            }
            //Scaling of all path
        ...
        public void InitialObstackleGenerater(ref PathGameObjectModel pathGameObjectModel, ref PathModel pathModel, PathController pathController, float oneunitySize, GameObject coins, float maxCoinHeight, int _noOfSize, ref ObstacleModel obstackleModel, ref float speed)
        {
            for (int i = 2; i <= pathController.tilesQuantity.Count; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 6:
                        //Generateing Coin and obstacles as Child of path
                        InstantiateCoinsAndObstacles(pathGameObjectModel.GeneratedPath6, xpos, coinLength, coinControllerViewModel.tilesQuantity,
                            oneunitySize, coins, ref pathModel, maxCoinHeight, _noOfSize, ref obstackleModel, pathName, ref speed);
                        break;
                    case 7:
                        //Generateing Coin and obstacles as Child of path
                        InstantiateCoinsAndObstacles(pathGameObjectModel.GeneratedPath7, xpos, coinLength, coinControllerViewModel.tilesQuantity,
                            oneunitySize, coins, ref pathModel, maxCoinHeight, _noOfSize, ref obstackleModel, pathName, ref speed);
                        break;
                    case 8:
                        //Generateing Coin and obstacles as Child of path
                        InstantiateCoinsAndObstacles(pathGameObjectModel.GeneratedPath8, xpos, coinLength, coinControllerViewModel.tilesQuantity,
                            oneunitySize, coins, ref pathModel, maxCoinHeight, _noOfSize, ref obstackleModel, pathName, ref speed);
                        break;
                }
            }
            ...
            switch (destroyPathNum)
            {
                    ...
                    if (!playerEnteringPathModel.IsEnterPath2)
                    {
                        ...
                        switch (noOfPath)
                        {
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                lastPathZPostion = pathGameObjectModel.GeneratedPath6.transform.position.z;
                                break;
                            case 7:
                                lastPathZPostion = pathGameObjectModel.GeneratedPath7.transform.position.z;
                                break;
                            case 8:
                                lastPathZPostion = pathGameObjectModel.GeneratedPath8.transform.position.z;
                                break;
                        }
                ...
                case 5:
                    switch (noOfPath)
                    {
                        ...
                        case 7:
                        case 6:                        
                            //Destroy plane and generate 5 when player enter in 6 plane
                            if (!playerEnteringPathModel.IsEnterPath6)
                            {
                                var GeneratedPathPositionZ = pathGameObjectModel.GeneratedPath6.transform.position.z;
                                var lastPathZPostion = pathGameObjectModel.GeneratedPath4.transform.position.z;
                                if ((Convert.ToInt32(GeneratedPathPositionZ) == playerPositionZ))
                                {
                                    playerEnteringPathModel.IsEnterPath6 = true;
                ...
                case 6:
                    switch (noOfPath)
                    {
                        case 8:
                        case 7:
                            //Destroy plane and generate 6 when player enter in 7 plane
                            if (!playerEnteringPathModel.IsEnterPath7)
                            {
                                var GeneratedPathPositionZ = pathGameObjectModel.GeneratedPath7.transform.position.z;
                                var lastPathZPostion = pathGameObjectModel.GeneratedPath5.transform.position.z;
                                if ((Convert.ToInt32(GeneratedPathPositionZ) == playerPositionZ))
                                {
                                    playerEnteringPathModel.IsEnterPath7 = true;
                                    playerEnteringPathModel.IsEnterPath6 = false;
                                    Destroy(pathGameObjectModel.GeneratedPath6);
                                    GeneratePath(new Vector3(0, 0, (lastPathZPostion + pathModel.PathSizeLength)), ref pathModel, ref pathNum, ref rarePathCount,
                                        ref rarePathRepeatAfterNoOfPath, ref rarePath, ref pathList, ref playerEnteringPathModel, ref pathGameObjectModel,
                                        ref rigidBodyModel, pathController, oneunitySize, coins, maxCoinHeight, _noOfSize, ref obstacleModel, ref speed);
                                }
                            ...
                            break;
                        case 6:
                            //Destroy plane and generate 6 when player enter in 1 plane
                            if (!playerEnteringPathModel.IsEnterPath1)
                            {
                                var GeneratedPathPositionZ = pathGameObjectModel.GeneratedPath1.transform.position.z;
                                var lastPathZPostion = pathGameObjectModel.GeneratedPath3.transform.position.z;
                ...
                case 7:
                    ...
                    {
                        case 8:                        
                            //Destroy plane and generate 7 when player enter in 8 plane
                            if (!playerEnteringPathModel.IsEnterPath8)
                            {
                                var GeneratedPathPositionZ = pathGameObjectModel.GeneratedPath8.transform.position.z;
                                var lastPathZPostion = pathGameObjectModel.GeneratedPath6.transform.position.z;
                                if ((Convert.ToInt32(GeneratedPathPositionZ) == playerPositionZ))
                                {
                                    playerEnteringPathModel.IsEnterPath8 = true;
                                    playerEnteringPathModel.IsEnterPath7 = false;
                                    Destroy(pathGameObjectModel.GeneratedPath7);
                                    GeneratePath(new Vector3(0, 0, (lastPathZPostion + pathModel.PathSizeLength)), ref pathModel, ref pathNum, ref rarePathCount,
                                        ref rarePathRepeatAfterNoOfPath, ref rarePath, ref pathList, ref playerEnteringPathModel, ref pathGameObjectModel,
                                        ref rigidBodyModel, pathController, oneunitySize, coins, maxCoinHeight, _noOfSize, ref obstacleModel, ref speed);
                                }
                    ...
                    break;
                case 8:
                    //Destroy plane and generate 8 when player enter in 1 plane	
                    if (!playerEnteringPathModel.IsEnterPath1)
                    {
                        var GeneratedPathPositionZ = pathGameObjectModel.GeneratedPath1.transform.position.z;
                        var lastPathZPostion = pathGameObjectModel.GeneratedPath7.transform.position.z;
                        if ((Convert.ToInt32(GeneratedPathPositionZ) == playerPositionZ))
                        {
                            playerEnteringPathModel.IsEnterPath1 = true;
                            Destroy(pathGameObjectModel.GeneratedPath8);
                            GeneratePath(new Vector3(0, 0, (lastPathZPostion + pathModel.PathSizeLength)), ref pathModel, ref pathNum,
            ...
            for (int i = 0; i < pathController.tilesQuantity.Count; i++)
            {
                switch (i)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        pathGameObjectModel.GeneratedPath6.transform.localScale = new Vector3(pathWidth, 1, pathLength);
                        rigidBodyModel.RigidbodyPath6 = pathGameObjectModel.GeneratedPath6.GetComponent<Rigidbody>();
                        break;
                    case 6:
                        pathGameObjectModel.GeneratedPath7.transform.localScale = new Vector3(pathWidth, 1, pathLength);
                        rigidBodyModel.RigidbodyPath7 = pathGameObjectModel.GeneratedPath7.GetComponent<Rigidbody>();
                        break;
                    case 7:
                        pathGameObjectModel.GeneratedPath8.transform.localScale = new Vector3(pathWidth, 1, pathLength);
                        rigidBodyModel.RigidbodyPath8 = pathGameObjectModel.GeneratedPath8.GetComponent<Rigidbody>();
                        break;
            ...
            ref ObstacleModel obstacleModel, ref float speed)
        {
            ...
            switch (pathNum)
            {
                ...
                case 6:
                    ...
                    pathGameObjectModel.GeneratedPath6 = newpath as GameObject;
                    pathGameObjectModel.GeneratedPath6.transform.localScale = new Vector3(pathWidth, 1, pathLength);
                    rigidBodyModel.RigidbodyPath6 = pathGameObjectModel.GeneratedPath6.GetComponent<Rigidbody>();
                    //Calling Function
                    GenerateCoins(pathGameObjectModel.GeneratedPath6, "tile6", pathController, oneunitySize, coins, ref pathModel, maxCoinHeight, _noOfSize, ref obstacleModel, ref speed);
                    playerEnteringPathModel.IsEnterPath6 = false;

                    break;
                case 7:

                    pathGameObjectModel.GeneratedPath7 = newpath as GameObject;
                    pathGameObjectModel.GeneratedPath7.transform.localScale = new Vector3(pathWidth, 1, pathLength);
                    rigidBodyModel.RigidbodyPath7 = pathGameObjectModel.GeneratedPath7.GetComponent<Rigidbody>();
                    //Calling Function
                    GenerateCoins(pathGameObjectModel.GeneratedPath7, "tile7", pathController, oneunitySize, coins, ref pathModel, maxCoinHeight, _noOfSize, ref obstacleModel, ref speed);
                    playerEnteringPathModel.IsEnterPath7 = false;

                    break;
                case 8:

                    pathGameObjectModel.GeneratedPath8 = newpath as GameObject;
                    pathGameObjectModel.GeneratedPath8.transform.localScale = new Vector3(pathWidth, 1, pathLength);
                    rigidBodyModel.RigidbodyPath8 = pathGameObjectModel.GeneratedPath8.GetComponent<Rigidbody>();
                    //Calling Function
                    GenerateCoins(pathGameObjectModel.GeneratedPath8, "tile8", pathController, oneunitySize, coins, ref pathModel, maxCoinHeight, _noOfSize, ref obstacleModel, ref speed);
                    playerEnteringPathModel.IsEnterPath8 = false;
