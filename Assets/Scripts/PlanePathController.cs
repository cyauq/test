...
namespace Xeemu.PathAutoGen
{
    public class PlanePathController : MonoBehaviour
    {
        ...
        //public variable using to get input from User in Inspector and assisgn these values to4
        ...
        void Start()
        {
            ...
            if (pathCount > 8 || pathCount < 2)
            {
                throw new Exception("Maximum 8 paths or minimum 2 paths are allowed or For more than 8 paths need to develop logical code for further funcionality");
            }

            //check noof coins value 
            numberOfCoins = pathController.numberOfCoins == 0 ? 3 : pathController.numberOfCoins;
            ...
            speed = PlayerPrefs.GetFloat("$sceneRun" + _sceneId + "_speed" + _user, pathController.platformSpeed);

            numberOfCoins = PlayerPrefs.GetInt("$sceneRun" + _sceneId + "_coinAmount" + _user, pathController.numberOfCoins);                      
            //calling Function
            SetPathModelValues();
            ...
            iPlanePathService.GeneratePath(ref pathPositionModel,
                                                ref pathGameObjectModel,
                                                ref pathList,
                                                ref rigidBodyModel,
                                                ref pathSize,
                                                pathController,
        ...
        void FixedUpdate()
        {
            if (_playerControllerObject != null)
            {
                ...
                {
                    if (_playerController.isBonus || _playerController.isPause || !_playerController.isStart)
                    {
                        speed = 0;
                    }
                    else
                    {
                        string _user = PlayerPrefs.GetString("$user", "");
                        int _id = PlayerPrefs.GetInt("$currentSceneID", 1);
                        speed = PlayerPrefs.GetFloat("$sceneRun" + _id + "_speed" + _user, 10f);               
                    }
            ...
            if (_playerControllerObject != null)
            {
                _playerController.totalDistance = distance;
                _playerController.maxSpeed = speed;
            }
        ...
        void MovingPath(float time)
        {
            ...
            switch (pathController.tilesQuantity.Count)
            {
                ...
                case 6:
                    ...
                    rigidBodyModel.RigidbodyPath4.MovePosition(pathGameObjectModel.GeneratedPath4.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath5.MovePosition(pathGameObjectModel.GeneratedPath5.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath6.MovePosition(pathGameObjectModel.GeneratedPath6.transform.position - new Vector3(0, 0, speed * time));
                    break;
                case 7:
                    rigidBodyModel.RigidbodyPath1.MovePosition(pathGameObjectModel.GeneratedPath1.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath2.MovePosition(pathGameObjectModel.GeneratedPath2.transform.position - new Vector3(0, 0, speed * time));
                    ...
                    rigidBodyModel.RigidbodyPath5.MovePosition(pathGameObjectModel.GeneratedPath5.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath6.MovePosition(pathGameObjectModel.GeneratedPath6.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath7.MovePosition(pathGameObjectModel.GeneratedPath7.transform.position - new Vector3(0, 0, speed * time));                    
                    break;
                case 8:
                    rigidBodyModel.RigidbodyPath1.MovePosition(pathGameObjectModel.GeneratedPath1.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath2.MovePosition(pathGameObjectModel.GeneratedPath2.transform.position - new Vector3(0, 0, speed * time));
                    ...
                    rigidBodyModel.RigidbodyPath6.MovePosition(pathGameObjectModel.GeneratedPath6.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath7.MovePosition(pathGameObjectModel.GeneratedPath7.transform.position - new Vector3(0, 0, speed * time));
                    rigidBodyModel.RigidbodyPath8.MovePosition(pathGameObjectModel.GeneratedPath8.transform.position - new Vector3(0, 0, speed * time));
                    break;
        ...
        void SetPathPositionModel()
        {
            ...
            path6ZPosValue = (path5ZPosValue + pathSize.PathSizeLength),
            path7ZPosValue = (path6ZPosValue + pathSize.PathSizeLength),
            path8ZPosValue = (path7ZPosValue + pathSize.PathSizeLength);
            ...
            pathPositionModel.Path6PosValue = new Vector3(0, 0, path6ZPosValue);
            pathPositionModel.Path7PosValue = new Vector3(0, 0, path7ZPosValue);
            pathPositionModel.Path8PosValue = new Vector3(0, 0, path8ZPosValue);
